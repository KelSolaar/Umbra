...
python $UTILITIES/getSphinxDocumentationApi.py "foundations,manager,umbra" "$SPHINX/source/resources/packages" "$SPHINX/source/resources/pages/api" "$SPHINX/source/resources/pages/api.rst"
