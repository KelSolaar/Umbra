...
LOGGING_THEME = {"default": get_format(format=DEFAULT_FORMAT, background_color=QColor(32, 32, 32)),
                 ...
                 "logging.message.debug.trace.in": get_format(format=DEFAULT_FORMAT, color=QColor(128, 160, 192),
                                                              italic=True),
                 "logging.message.debug.trace.out": get_format(format=DEFAULT_FORMAT, color=QColor(192, 160, 128),
                                                               italic=True)}
